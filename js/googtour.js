		var start_point = new google.maps.LatLng(51.370387,-0.79196);
		var end_point = new google.maps.LatLng(51.361532,-0.798526);
		var lookat_point = new google.maps.LatLng(51.361492,-0.798547);
...
// 			overlay.setMap(map);
			...
			scn.add(o, 'screen_width', window.innerWidth - 50).listen();
			...
			window.addEventListener('resize', function(){
				hyperlapse.setSize(window.innerWidth - 50, window.innerHeight);
				o.screen_width = window.innerWidth - 50;
